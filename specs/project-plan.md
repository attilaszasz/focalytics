...
- [ ] E006 [P2] [TECHNICAL] [P] {PRD:CAP-007}{SAD:ADR-005} Publish Installable Releases — automate cross-platform builds, checksums, and package-manager metadata from immutable release artifacts.
