...
```bash
curl -fsSLO https://github.com/attilaszasz/focalytics/releases/download/v0.0.9/focalytics_v0.0.9_darwin_arm64.tar.gz
tar -xzf focalytics_v0.0.9_darwin_arm64.tar.gz
...
```bash
curl -fsSLO https://github.com/attilaszasz/focalytics/releases/download/v0.0.9/focalytics_v0.0.9_linux_amd64.tar.gz
tar -xzf focalytics_v0.0.9_linux_amd64.tar.gz
sudo mv focalytics /usr/local/bin/
```
...
```powershell
Invoke-WebRequest -Uri https://github.com/attilaszasz/focalytics/releases/download/v0.0.9/focalytics_v0.0.9_windows_amd64.zip -OutFile focalytics.zip
...
Each release includes a checksum file named `focalytics_v0.0.9_checksums.txt`.

To verify a downloaded archive:

```bash
curl -fsSLO https://github.com/attilaszasz/focalytics/releases/download/v0.0.9/focalytics_v0.0.9_checksums.txt
sha256sum -c focalytics_v0.0.9_checksums.txt --ignore-missing
```
